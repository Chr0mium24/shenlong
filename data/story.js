export const story = [
  {
    ...
    lines: [
      '男皇后。',
      '属性值：1.须眉骨 2.红粉相 3.大王好感度 4.面具值。',
      '你姓陈名子高，自小于江南长大。幼时家门显赫，后父母双亡，家道中落。',
      '你现在在干戈营中打杂。',
      '于干戈营中，突然有一天锣鼓喧天，好似什么军队来了。你只见人高马大，这将军好威风，似打胜仗归来。',
  ...
  },
  {
    ...
    lines: [
      ...
      '你知道如果当时不这么回答，也只有充军苦了的份，但是如今女妆粉黛的，你很是不习惯。',
      ...
      '有对于君恩的感激，你想过假若你是女子，纵然有沉鱼落雁之姿、花容月貌之势，也未见得能有如今这么容易。',
      '有对于自己身为男子的羞愧。你从小饱读诗书，也曾是名门望族；向来都说男子当齐家治国平天下，以色侍人怕不是列不进族谱。',
      '礼成入洞房，你必须表态。'
    ],
    choices: [
      {
  ...
  },
  {
    ...
    title: '玉华公主',
    lines: [
      '大王有一位特别宠爱的妹妹，众人称玉华公主。她云鬓斜插金凤，明珠垂耳，眉眼之间只留一抹余光看人。',
      '纵然她有些许骄纵，但有时却也有些可爱。',
      '她好奇来见你：“本公主倒要瞧瞧，能被哥哥瞧上的女人如何倾国倾城。”',
      '往后她隔三差五来找你，你也只当作妹妹一般。先是撒娇借鞋，后又言语轻薄，甚至以自缢相逼。',
  ...
  },
  {
    ...
    choices: [
      {
        id: 'fourth_a',
        text: '“都是玉华公主屡次三番地来披香殿中纠缠！臣妾深知会惹人非议，向来闭门不出。可公主不仅言语轻薄，甚至以死相逼，强行将这柄白团扇塞进臣妾怀里。臣妾若是不收，她便要在园中寻死觅活。臣妾在这深宫之中不过浮萍一叶，哪里敢当面拂了金枝玉叶的面子？求大王为臣妾做主啊！”',
        next: 'ending_5'
      },
      {
        id: 'fourth_b',
  ...
  },
  {
    ...
    lines: [
      ...
      '为了彻底洗刷这段流言，大王为她精挑细选了一位门当户对的世家公子做驸马。',
      '十里红妆出降那天，喜乐声甚至隐隐传到了冷宫的红墙内。',
      '公主依然是金尊玉贵的公主，大王依然是高高在上的大王。而你呢？',
      '你低头看着井水中渐渐枯槁的倒影，终于苦笑着明白：戏台塌了，只有你这个被强行拉上台的戏子，要用一生来陪葬。',
  ...
  },
  {
    ...
    lines: [
      ...
      '那一刻你已泪流满面，你也不知道是侥幸，是愧疚，还是对这段善缘的叹惋。',
      '后来大王赐婚，许你做玉华公主驸马。满城称颂十里红妆，却见你仍着娘娘装束。',
      '你感觉这一幕好熟悉。当时大王十里红妆娶你时，也是这般。',
      '也许大王要你身着娘娘衣裳，也是在惩罚当初的欺君之罪。',
